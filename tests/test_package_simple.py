"""
Simple test for Power BI package download system (no emojis)
"""
...
def test_package_creation():
    ...
    print("\n[Step 2] Processing with ETL pipeline...")
    processor = ExcelToPowerBIProcessor()
    processor.template_type = 'sales_performance'
    ...
    if all_checks_passed:
        ...
        print("\nPackage Contents:")
        print("   [OK] CSV data files (ready for Power BI import)")
        print("   [OK] Dashboard model JSON (metadata)")
        print("   [OK] DAX measures file (copy-paste ready)")
        print("   [OK] Quick Start guide (step-by-step instructions)")
        print("\nUsers can now:")
...
if __name__ == "__main__":
    try:
        ...
        if package:
            print(f"\n[OK] Package ready for download: {package}")
